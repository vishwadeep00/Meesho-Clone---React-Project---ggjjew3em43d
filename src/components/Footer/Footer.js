...
export default function Footer() {
  return (
    <div className='footer-container'>
      ...
      <div className='footer-container-3' style={{marginLeft:'70px'}}>
      ...
      <div className='footer-container-4' style={{marginLeft:'70px'}}>
      ...
      <div className='footer-container-5' style={{marginLeft:'70px'}}>
